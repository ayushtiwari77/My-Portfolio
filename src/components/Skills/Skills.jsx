...
const Skills = () => {
  return (
    <section
      id="skills"
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans my-skills-gradient "
    >
      {/* section Title */}
      ...
      <div className="flex justify-center  flex-col md:flex-row  flex-wrap gap-1 lg:gap-5 py-10 items-center md:items-stretch ">
        {SkillsInfo.map((category) => (
          ...
          >
            ...
            {/* skill items - 3per row for larger screens*/}
              ...
              <div className="grid grid-cols-2  gap-1  w-full">
                {category.skills.map((skill) => (
                  ...
                  >
                    ...
                    />
                    <span className="text-xs 2xl:text-sm text-gray-300">
                      {skill.name}
                    </span>
                  </div>
                ))}
